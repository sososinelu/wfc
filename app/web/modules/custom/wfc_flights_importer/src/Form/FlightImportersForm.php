...
namespace Drupal\wfc_flights_importer\Form;

use Drupal\Core\Form\FormBase;
use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Url;
use Drupal\wfc_flights_importer\Controller\WfcFlightsImporter;
...
class FlightImportersForm extends FormBase {
  ...
  public function getFormId() {
    return 'wfc_flights_importer_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($flights_data = WfcFlightsImporter::processUpload($this->csv_file)) {
    ...
    //$form_state->setRedirectUrl(new Url('wfc_flights_importer.importers'));
