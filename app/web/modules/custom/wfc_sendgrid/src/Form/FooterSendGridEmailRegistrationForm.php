...
/**
 * @file
 * Contains \Drupal\wfc_sendgrid\Form\FooterSendGridEmailRegistrationForm.
 */
 ...
 */
class FooterSendGridEmailRegistrationForm extends FormBase {
  ...
  public function getFormId() {
    return 'footer_sendgrid_email_registration_form';
  }
  ...
  public function processSubmit(array $form, FormStateInterface $formState) {
    $email = $formState->getValue('footer_email');
